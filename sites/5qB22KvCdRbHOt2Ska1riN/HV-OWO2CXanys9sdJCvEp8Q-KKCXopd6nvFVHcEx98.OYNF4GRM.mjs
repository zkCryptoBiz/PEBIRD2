                      ...
                      ..._a(
                        {
                          dYYLo0BmC: {
                            background: {
                              ...
                              positionY: 'bottom',
                              sizes: '187px',
                              src: './images/FLYAIRETARTD1.png',
                              srcSet:
                                './images/FLYAIRETARTD1.png?scale-down-to=1024 837w,./images/FLYAIRETARTD1.png 1056w',
                            },
                          },
                        },
                        h,
                                  ...
                                  r(D, {
                                    children: r(H, {
                                      ...
                                      children: r(er, {
                                        bZsnTBIZu: 'rgb(21, 39, 102)',
                                        CiWo9qyo0:
                                          'https://dexscreener.com/solana/chachache',
                                        height: '100%',
                                        id: 'bOHANc5rB',
                                        jkUJRz9gR: Qr(
                                          {
